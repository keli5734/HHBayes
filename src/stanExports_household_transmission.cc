...
#include "stanExports_household_transmission.h"

RCPP_MODULE(stan_fit4household_transmission_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_household_transmission")
